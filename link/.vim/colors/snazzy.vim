" Fork of https://github.com/rakr/vim-one
" Name:    snazzy vim colorscheme
...
if has('gui_running') || has('termguicolors') || &t_Co == 88 || &t_Co == 256
  ...
  if &background ==# 'dark'
    let s:dark = 1
    let s:mono_1 = ['#eff0eb', '145']
    let s:mono_2 = ['#828997', '102']
    let s:mono_3 = ['#5c6370', '59']
    let s:mono_4 = ['#4b5263', '59']

    let s:hue_1  = ['#9aedfe', '73'] " cyan
    let s:hue_2  = ['#57c7ff', '75'] " blue
    let s:hue_3  = ['#ff6ac1', '176'] " purple
    let s:hue_4  = ['#5af78e', '114'] " green

    let s:hue_5   = ['#ff5c57', '168'] " red 1
    let s:hue_5_2 = ['#be5046', '130'] " red 2

    let s:hue_6   = ['#f3f99d', '173'] " orange 1
  ...
  call <sid>X('jsGlobalNodeObjects',        s:hue_6_2, '', '')
...
" Public API --------------------------------------------------------------{{{
function! snazzy#highlight(group, fg, bg, attr)
